        ...
        return $form
            ->schema([
                ...
                Forms\Components\Select::make('packaging_id')
                    ->relationship('packaging', 'id'),
                Forms\Components\TextInput::make('frais_emballage')
                    ->required()
                    ->numeric()
                    ->default(0),
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('devise_code')
                    ->searchable(),
                Tables\Columns\TextColumn::make('sous_total')
                    ->numeric()
                    ->sortable(),
                Tables\Columns\TextColumn::make('packaging.id')
                    ->numeric()
                    ->sortable(),
