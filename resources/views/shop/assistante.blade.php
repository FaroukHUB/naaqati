<x-shop-layout :title="'Assistante Naaqati'">
    <div class="mx-auto max-w-md text-center">
        <div class="mx-auto mb-5 flex h-20 w-20 items-center justify-center rounded-3xl text-white shadow-lg" style="background:linear-gradient(135deg,#C98B96,#9B5563);">
        ...
        <div class="mt-8">
            <a href="{{ route('shop.catalog') }}" class="inline-block rounded-xl px-6 py-3 text-sm font-semibold text-white" style="background-color:#B76E79;">
                Voir les produits
            </a>
        </div>
    </div>
